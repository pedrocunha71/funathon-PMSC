...
Train the model (it should take about 5 minutes to train). 
...
1.  Subsample a fraction ( `0.1` ) of the `df` dataset to reduce computation time and define X_train, X_test, y_train and y_test.
